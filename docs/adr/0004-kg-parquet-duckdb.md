...
- **Status**: Accepted
- **Context**: IntelliqX does not need real-time graph traversals; batch and RAG-style retrieval suffice.
...
- **Consequences**:
  - Pros: zero managed DB cost, portable (runs anywhere Python runs), scales to millions of edges.
