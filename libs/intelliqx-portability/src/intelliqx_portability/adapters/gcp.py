...
access lives in feature-specific libs (``aqip-storage.gcp``,
``aqip-events.gcp`` …). The adapter exposes the resolved config and
...
class GCPAdapter(CloudAdapter):
    ...
    in :class:`~aqip_portability.config.CloudConfig` and accessible
